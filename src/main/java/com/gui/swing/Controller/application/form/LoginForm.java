...
//import com.gui.swing.Service.AuthenticationServiceImpl;
...
//
//
//        GeneralResponse authenticationResult = authenticationService.authentication(username, password);
//
//        if (authenticationResult.getStatus() == 1 || authenticationResult.getStatus() == 2) {
//            // Đăng nhập thành công
//            ApplicationForm.login();
//        } else {
//            System.err.println(authenticationResult.getMessage());
//            // Đăng nhập thất bại
//            JOptionPane.showMessageDialog(this, authenticationResult.getMessage(), "Đăng nhập thất bại", JOptionPane.ERROR_MESSAGE);
//        }
//    }
//
